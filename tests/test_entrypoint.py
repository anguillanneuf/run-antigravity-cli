...
@pytest.mark.asyncio
@patch("src.entrypoint.GitHubEventContext.from_env")
async def test_entrypoint_no_pr_number(mock_context_from_env):
...
@pytest.mark.asyncio
@patch("src.entrypoint.GitHubEventContext.from_env")
async def test_entrypoint_issue_comment_not_requested(mock_context_from_env):
...
@patch("src.entrypoint.GitHubEventContext.from_env")
@patch("src.entrypoint.GitHubClient")
async def test_entrypoint_empty_diff(mock_client_cls, mock_context_from_env):
